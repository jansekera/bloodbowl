...
| **3.** | **FABLE 19.08.** — spouštěč splněn ranním čtením noci. Doporučeno **kandidát ① „kolik rohů klece je optimum"** *(nepotřebuje nový korpus — počty rohů oprava `HAND_OFF` ani `corridor_resistance` neovlivňují, takže neblokuje na 14:30)* | jedna Fable analýza denně; dnešek jí dluží den | ne (jen čtení) |
