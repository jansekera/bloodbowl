...
| **8.** | vybrat a spustit **noční A/B** — ⭐ **favorit je nově P34** *(cílové pole vlastního pohybu se posuzuje proti kleci)*: strop **1,36–3,82 rohu/zápas**, cena **záporná**, legitimní překážky jen 2,0 %. Před ním **P35** *(blitz oceňovaný z výchozího pole, ≈0,9 blitzu/zápas s obráceným znaménkem kostek)* — obojí je táž chybějící dimenze **KAM**. **P32** klesá na třetí. | ✅ **T2.16 splněno, odblokováno** | **ano, 14 h** |
