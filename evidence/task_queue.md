...
| **8.** | vybrat a spustit **noční A/B** — favorit **P32** *(klec se posouvá jen rovně kupředu, `cage_advance.cpp:41`)*; ⭐ nový kandidát **P34** *(tělo z ortogonálního pole do rohu)*, jakmile Fable rozebere, kolik z toho stropu je zadarmo | ✅ **T2.16 splněno, odblokováno** | **ano, 14 h** |
