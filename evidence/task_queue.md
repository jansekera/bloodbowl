...
| **P37** | ⚠️ **`carrierIsBlitzable` NEZNÁ GFI** (`macro_actions.cpp:1162`): `distance <= opp.stats.movement`, ale CRP dovolí **2 pole navíc**. Test rozhoduje, jestli si nosič nechá pohyb v záloze. **19 964 kol: v 6,3 % (1 266 = 0,42 kola/zápas) kód říká BEZPEČNO a soupeř dosáhne přes GFI.** Ležící soupeř je vyloučen úplně, ač postavení stojí 3 MP ⇒ dosáhne na MA−3. ⚠️ **Menší nález:** zdržet pohyb je často správně i tak, takže kolik by sprint zlepšil, se odsud říct nedá — vada je, že se test tváří jako fakt o dosahu. | **OTEVŘENO — zapsáno 19.08., NÍZKÁ PRIORITA** |
