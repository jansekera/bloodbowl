...
| **T5.25** | ⛔ **SAFE THROW JE VEDLE V OBOU PŮLKÁCH** *(T5.21, 25.08.)*. BB2016 ř. **8434-8441**. `pass_handler.cpp:116-124` hází proti `intTarget`, což je **cíl INTERCEPTORA** *(jeho AG, jeho −2, jeho tackle zóny)*; pravidlo chce **nemodifikovaný AG hod HÁZEČE**. A **druhá věta skillu** *(fumble na jiný než přirozený 1 se jako fumble nepočítá)* v kódu **není vůbec**.<br>⚠️ **Pomáhá to SOUPEŘŮM** — Safe Throw je passingová dovednost, trpaslík ji nemá. Táž rodina jako F6/F7/F8. | **OTEVŘENO — ŽIVÉ, NÍZKÁ** *(navazuje na odložený model přihrávek, T5.19)* |
