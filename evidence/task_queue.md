...
| ⏰⏰ **P42** | zákaz „nosič nekončí v kontaktu" | ⭐ **PŘESKUPENO 10.09.:** dimenze KAM je **hotová i otestovaná od 07.08.** a pokrývá **0,5 %** porušení; **26,2 % kol dává soupeři blok ZDARMA** a zbývají **dvě jiná ramena** *(ústup po blitzu `:1383` 38,6 % · útěk stojícího nosiče `:2054` 57,7 %)* |
