...
| ⏰ **NOVĚ 21.09.: týmový přehoz HODU PRO u chytání po odskoku není zapojený** | 8387: „you can re-roll the Pro roll with a Team re-roll" | `resolveCatchFromBounce` volá `ProCheck::roll(..., false, ...)`; na rozdíl od `resolveCatch` sem neteče `teamRerollAvailable` — chtělo by to i kontrolu vlastního kola | – | – | jistá |
