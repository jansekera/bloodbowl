...
ARMS = {
    "pb0":   dict(pb=0.0,  bench=False, n=8 if SMOKE else 70),
    "pb015": dict(pb=0.15, bench=False, n=8 if SMOKE else 70),
    "bm0":   dict(pb=0.0,  bench=True,  n=8 if SMOKE else 50),
    "bm015": dict(pb=0.15, bench=True,  n=8 if SMOKE else 50),
}
