#!/bin/bash
# ============================================================================
# NOC 02.->03.09.2026  —  Q3 / mode 16  (oceneni tri vetvi vstavani)
# Predregistrace: evidence/night_prereg_20260903_q3n.preds
#
...
python3 colab_night_preflight.py --mode 16 --matchups "2:dw-dw:1" \
        ...
        --prereg evidence/night_prereg_20260903_q3n.preds \
        --session-hours 16 || {
...
OUT=$PWD/ab_q3n_20260903 MODE=16 MATCHUPS="2:dw-dw:1" PAIRS=2400 \
